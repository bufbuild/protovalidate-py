...
_ProtovalidateMistypedRuleFields: TypeAlias = Literal["val"]

class ProtovalidateMistypedRule(Message[_ProtovalidateMistypedRuleFields]):
    """
    ```proto
    message tests.example.v1.ProtovalidateMistypedRule
    ```

    Attributes:
        val:
            The duration rule cannot be compiled for a string field.
...
_DESC = file_desc(
    ...
    ],
    {
        ...
        "ProtovalidateMistypedRule": ProtovalidateMistypedRule,
